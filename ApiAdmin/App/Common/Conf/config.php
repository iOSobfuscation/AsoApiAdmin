...
return array(
	...
	'MODULE_ALLOW_LIST'       => array('Admin', 'Mshop','NewAdmin','Plant','Home'), //支持的目录名称
	'GOODS_MODEL'          	  => 'oo.rscne.com',//商品属性模块
	'HOST_NAME'          	  => '',//配置域名
	...
	'DB_HOST'                 => '101.200.91.203',  // 服务器地址
	'DB_NAME'                 => 'exam',         // 数据库名
	'DB_USER'                 => 'root',        // 用户名
	'DB_PWD'                  => 'ttttottttomysql', // 密码
	 'DB_PORT'                 => '3306',       // 端口
 ...
 //       '/^p-(\d+)$/' => 'index.php/Admin/Index/login',//意思是访问x.com/p-34 会访问的是x.com/Blog/index/id/34  
 ...
 //         ),  
	...
	'FILE_UPLOAD_CONFIG'       => array(
		...
		'exts'          => array('jpg','gif','png','jpeg','zip','rar','tar','gz','7z', 'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx','txt','xml','swf','avi','mov'), //允许上传的文件后缀
